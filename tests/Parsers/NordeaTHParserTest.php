...
class NordeaTHParserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $data = 'VV  1160104EX16004VX9    17001511824   EUREE367700771111111111               Firma O�                                   Arve 220/NE                                                                C 000000033477';
        $payments = $this->_parser->parseData($data);
        $this->assertEquals(new \Entities\Payment('334,77', 'EX16004VX9', '220/NE', 'Firma O�'), $payments->offsetGet(0));
    }
...
VV  1160104EX16004VX9    17001511824   EUREE367700771111111111               Firma O�                                   Tellimus 2016041920                                                        C 000000033477
DATA;
        $payments = $this->_parser->parseData($data);
